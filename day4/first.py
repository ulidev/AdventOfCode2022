...
for element in data:
	...
	if (first_start <= second_start and second_end <= first_end) or (first_start >= second_start and second_end >= first_end): accumulated_counter += 1

print("Fully contained:", accumulated_counter)
